...
const tags = require('./api/controllers/tags');
...
class Server {
  ...
  async setupCors() {
    ...
    // enables CORS
    this.app.use('/tags', cors(corsOptions));
  }
